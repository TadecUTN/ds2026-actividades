...
function Catalogo() {
    ...
    }, [libros, busqueda, soloDisponibles, ordenarPor, categoria]);
        ...
        return (
            <Container className="my-5">
                <Alert variant="danger" className="text-center">
                    Hubo un error al cargar el catálogo: {error}
                </Alert>
            </Container>
        );
    }
        ...
        <Container className="my-5 animacion-entrada">
            ...
            <div className="tarjeta-vidrio p-4 mb-5 catalogo-filter-card">
                <Row className="g-3 align-items-center">
                    ...
                    <Col lg={3} md={6}>
                        <Form.Label className="form-label-premium">Filtrar Categoria</Form.Label>
                        <Form.Select
                            value={categoria}
