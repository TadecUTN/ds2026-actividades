...
export const AUTH_RATE_LIMIT_WINDOW_MS = Number(obligatorio("AUTH_RATE_LIMIT_WINDOW_MS"));
export const AUTH_RATE_LIMIT_MAX = Number(obligatorio("AUTH_RATE_LIMIT_MAX"));